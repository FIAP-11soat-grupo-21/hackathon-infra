...
dependency "sns_topic_chunk_processed" {
  config_path = "../../SNS/chunk-processed"
...
inputs = {
  queue_name                 = "update-video-chunk-status"
  delay_seconds              = 0
  message_retention_seconds  = 86400
  receive_wait_time_seconds  = 10
  visibility_timeout_seconds = 30
  sns_topic_arns             = [dependency.sns_topic_chunk_processed.outputs.topic_arn]
