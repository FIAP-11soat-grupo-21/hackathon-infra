...
dependency "sns_topic_video_completed" {
  config_path = "../../SNS/video-processing-complete"
...
dependency "sns_topic_video_error" {
  config_path = "../../SNS/video-processed-error"
...
inputs = {
  queue_name                 = "update-video-status"
  delay_seconds              = 0
  message_retention_seconds  = 86400
  receive_wait_time_seconds  = 10
  visibility_timeout_seconds = 30
  sns_topic_arns             = [dependency.sns_topic_video_completed.outputs.topic_arn, dependency.sns_topic_video_error.outputs.topic_arn]
